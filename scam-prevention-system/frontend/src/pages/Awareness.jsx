          ...
          <article className="bg-white rounded-xl article-card-shadow p-8 border border-gray-100 transition-transform duration-300 hover:scale-[1.01]">
            ...
            <div className="pt-6 border-t border-gray-100">
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all font-bold border ${
                  likes.article1.isLiked ? 'bg-primary text-white border-primary' : 'text-primary border-transparent hover:bg-gray-50'
                }`}
              >
          ...
          <article className="bg-white rounded-xl article-card-shadow p-8 border border-gray-100 transition-transform duration-300 hover:scale-[1.01]">
            ...
            <div className="pt-6 border-t border-gray-100">
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all font-bold border ${
                  likes.article2.isLiked ? 'bg-primary text-white border-primary' : 'text-primary border-transparent hover:bg-gray-50'
                }`}
              >
          ...
          <article className="bg-white rounded-xl article-card-shadow p-8 border border-gray-100 transition-transform duration-300 hover:scale-[1.01]">
            ...
            <div className="pt-6 border-t border-gray-100">
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all font-bold border ${
                  likes.article3.isLiked ? 'bg-primary text-white border-primary' : 'text-primary border-transparent hover:bg-gray-50'
                }`}
              >
          ...
          <article className="bg-white rounded-xl article-card-shadow p-8 border border-gray-100 transition-transform duration-300 hover:scale-[1.01]">
            ...
            <div className="pt-6 border-t border-gray-100">
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all font-bold border ${
                  likes.article4.isLiked ? 'bg-primary text-white border-primary' : 'text-primary border-transparent hover:bg-gray-50'
                }`}
              >
